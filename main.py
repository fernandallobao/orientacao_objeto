...
if __name__ == '__main__':
    ...
    usuario1 = Pessoa(nome2, humor=True)
    usuario2 = Pessoa(nome1, humor=True)

    #saida de dados
    print(usuario1.cumprimentar(nome1,nome2, humor=True))
    print(usuario2.resposta_cumprimentar(nome1, nome2, humor=True))                                                                       
